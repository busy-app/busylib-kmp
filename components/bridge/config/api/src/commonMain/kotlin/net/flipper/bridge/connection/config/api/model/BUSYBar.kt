...
class BUSYBar internal constructor(
    ...
    val serialNumber: String? = null, // default for serialization
    ...
    override fun toString(): String {
        return "BUSYBar(humanReadableName='$humanReadableName', hardwareId=$serialNumber, uniqueId='$uniqueId', ble=$ble, cloud=$cloud, lan=$lan, mock=$mock, onCallEnabled=$onCallEnabled, connectionWays=$connectionWays)"
    }
