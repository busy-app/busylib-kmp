...
class FTransportListenerImpl : LogTagProvider {
    ...
    fun onErrorDuringConnect(device: FDeviceCombined, throwable: Throwable) {
    ...
    fun onStatusUpdate(device: FDeviceCombined, status: FInternalTransportConnectionStatus) {
