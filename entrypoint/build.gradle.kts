...
kotlin {
    ...
    sourceSets.commonMain.dependencies {
        ...
        api(projects.components.bridge.device.firmwareUpdate.api)
        implementation(projects.components.bridge.device.firmwareUpdate.impl)
    ...
    targets
        ...
        .forEach { target ->
            target.binaries.framework {
                ...
                export(projects.components.bridge.device.firmwareUpdate.api)
