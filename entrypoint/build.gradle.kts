...
kotlin {
    sourceSets.commonMain.dependencies {
        ...
        api(projects.components.tools.firmwareUpdate.api)
        implementation(projects.components.tools.firmwareUpdate.impl)
    ...
    targets
        ...
        .forEach { target ->
            target.binaries.framework {
                ...
                export(projects.components.tools.firmwareUpdate.api)
