package net.flipper.bridge.connection.utils.config.impl
...
import net.flipper.bridge.connection.utils.config.preference.BleConfigSettingsKrate
import net.flipper.bridge.connection.utils.config.preference.BleConfigSettingsKrateImpl
